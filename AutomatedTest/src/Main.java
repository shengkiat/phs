...
public class Main {
	...
	private static long sleepShort = 1000; 
	private static String formBuilderLocation = "form-builder-frame-8";
	private static String phsURLPath = "https://medworks.nus.edu.sg/phs";
	private static String geckodriver = "lib\\GeckoDriver\\geckodriver.exe";
	...
	private static String generateNRIC() {
	...
	private static void testGoToHistoryTaking(CharSequence nric) throws InterruptedException {
	...
	private static void testConsentForm(CharSequence nric) throws InterruptedException {
	...
	private static void testRegistrationForm(CharSequence nric) throws InterruptedException {
	...
	private static void testMegaSortingStation() throws InterruptedException {
	...
	private static void testCreateUser(CharSequence nricString) throws InterruptedException {
	...
	private static void testLogout() throws InterruptedException {
	...
	private static void testMenuItems() throws InterruptedException {
