...
update DataCollection set [Label Text] = '<p style=''color:red''><b>PLEASE MEASURE PARTICIPANT''S BLOOD PRESSURE. Ensure participant is comfortable at rest before measuring their BP. They should not have taken caffeine or smoked in the past 30 minutes either.</b></p>

TAKE 1ST BP READING NOW & RECORD ON FORM A.' where id = 32 
...
*If exercises are dangerous or deemed inappropriate, to REFER FOR PHYSIOTHERAPIST CONSULATION. ' where id = 194
...
If participant cannot remember his/her weight, ask if there was any significant loss in weight the past year.' where id = 205
...
ii) Requires home modification (determined by SAOT) - Refer to Form A' where id = 269
...
- Have not been previously diagnosed with diabetes mellitus OR hyperlipidemia OR hypertension 没有被诊断患有高血压 或 高血脂 或 高血压' where id = 291
