...
TAKE 1ST BP READING NOW & RECORD ON FORM A.</b></p>
' where id = 40 
...
ii) Requires home modification (determined by SAOT) - Refer to Form A' where id = 309
...
(collectively referred to as  the “Organisers”).' where id = 378
...
Unless otherwise indicated below, I consent to the Organisers and HPB directly disclosing my Information to HPB’s Collaborators  for the purposes of checking whether I would require re-screening, further tests, follow-up action and/or referral to community programmes / activities.' where id = 384
