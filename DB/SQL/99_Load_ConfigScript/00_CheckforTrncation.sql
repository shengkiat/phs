...
Select 1 = Fits the assessment criteria; Select 0 = Does not fit the criteria; participant is well.' where id = 172 
...
*If exercises are dangerous or deemed inappropriate, to REFER FOR PHYSIOTHERAPIST CONSULATION. ' where id = 213
...
If participant cannot remember his/her weight, ask if there was any significant loss in weight the past year.' where id = 224
...
- Have not been previously diagnosed with diabetes mellitus OR hyperlipidemia OR hypertension 没有被诊断患有高血压 或 高血脂 或 高血压' where id = 313
...
Unless otherwise indicated below, I consent to the Organisers and HPB directly disclosing my Information to HPB’s Collaborators  for the purposes of checking whether I would require re-screening, further tests, follow-up action and/or referral to community programmes / activities.' where id = 368
